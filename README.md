...
[![Integration level](https://apps.yunohost.org/badge/integration/cjdns)](https://ci-apps.yunohost.org/ci/apps/cjdns/)
![Working status](https://apps.yunohost.org/badge/state/cjdns)
![Maintenance status](https://apps.yunohost.org/badge/maintained/cjdns)
