...
[![集成程度](https://apps.yunohost.org/badge/integration/cjdns)](https://ci-apps.yunohost.org/ci/apps/cjdns/)
![工作状态](https://apps.yunohost.org/badge/state/cjdns)
![维护状态](https://apps.yunohost.org/badge/maintained/cjdns)
